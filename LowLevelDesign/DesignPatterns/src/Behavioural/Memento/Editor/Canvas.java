...
import Behavioural.Memento.commands.ColorCommand;
import Behavioural.Memento.commands.MoveCommand;
import javax.swing.*;
    ...
    private void attachMouseListeners() {
        MouseAdapter colorizer = new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                Shape target = (Shape) editor.getShapes().getChildAt(e.getX(), e.getY());
                if (target != null) {
